...
const HeroSection = () => {
  const scrollToShop = () => {
    document.getElementById("shopnow-section").scrollIntoView({
      behavior: "smooth",
    });
  };
  return (
...
quality clothing that fits your life and your budget.</p>
   <div className="flex justify-center" onClick={scrollToShop}>
        <button className="inline-flex text-white bg-orange-500 border-0 py-2 px-6 focus:outline-none hover:bg-orange-600 rounded text-lg cursor-pointer">Shop Now</button>
      </div>
    </div>
