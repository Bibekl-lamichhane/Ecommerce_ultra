  ...
  <div className="container mx-auto">
    <div className="lg:w-300  mx-auto flex flex-wrap">
      ...
      <div className="flex gap-5 my-3 items-center">
        ...
        <h1 className="text-black text-3xl title-font font-medium mb-1">{productDetails.name}</h1>
        <div className="flex mb-4">
          <span className="flex items-center">
            ...
            color2={"#ffd700"}
          />
            <span className="text-black ml-3">{productDetails.no_of_ratings} Reviews</span>
          </span>
          <span className="flex ml-3 pl-3 py-2 border-l-2 border-black space-x-2s">
        ...
        <div className="flex  gap-18 mt-6 items-center pb-5 border-b-2 border-black mb-5">
          <div className="flex">
      ...
      <FormControl fullWidth>
        ...
        <div className="flex gap-4">
          <span className="title-font font-medium text-2xl text-black">NRS {productDetails.actual_price}</span>
      ...
      >
        <FavoriteIcon className= {existInWishlist===true?"text-red-500" : "text-black"} onClick={handleAddToWish} />
      </IconButton>
